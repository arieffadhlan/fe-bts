      ...
      {checklist && checklist.length > 0 ? (
        <div className="flex flex-wrap gap-5">
          {checklist.map((note, index) => (
            <Link to={`/checklist/${note.id}`} key={index} className="relative min-w-60 min-h-28 border border-solid border-gray-300 rounded-md bg-white transition-shadow duration-300 ease hover:shadow">
